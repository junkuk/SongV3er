    ...
    partial class GameForm
    {
        ...
        private void ConfigurarUI_SigueLaLetra()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                {
                    bool algunaOpcionSeleccionada = opcionesRadio.Any(r => r.Checked);
                    if (btnVerificar != null)
                    {
                        btnVerificar.Enabled = algunaOpcionSeleccionada;
                    }
                    // DEJAMOS btnSiguiente deshabilitado/invisible hasta después de la verificación
                };
        ...
        private void ConfigurarUI_AdivinaTituloyArtista()
        {
            //cambio de tamaño de form
            const int Margen = 80;
            int anchoUtil = this.ClientSize.Width - 2 * Margen;
            ...
            lblTitulo = new Label
            {
                Text = "🎵 Adivina la cancion y artista 🎵",
                Font = new Font("Segoe UI", 28, FontStyle.Bold),
                ForeColor = Color.FromArgb(46, 204, 113),
                AutoSize = true,
                TextAlign = ContentAlignment.MiddleCenter
        ...
        private void ConfigurarUI_AdivinaArtista()
        {
            //cambio de tamaño de form
            const int Margen = 80;
            int anchoUtil = this.ClientSize.Width - 2 * Margen;
